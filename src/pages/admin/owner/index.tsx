...
import { Pagination } from "@/components/pagination/Pagination"; // ของทีมที่มี onClick
...
export default function AdminOwnerListPage() {
  ...
  // ----- fetch list from API (pages/api/admin/owners/get-owners.ts) -----
  useEffect(() => {
    let cancelled = false;
  ...
  >
    <SearchInput
      ...
      onChange={setQ}
      onSubmit={() => setPage(1)}
      className="md:w-[260px]" // ถ้าต้องการกว้างขึ้นบนจอใหญ่
    />
  </form>
</PageHeader>
