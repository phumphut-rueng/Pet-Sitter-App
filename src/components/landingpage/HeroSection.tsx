  ...
  return (
    <section className="container mx-auto py-8 sm:py-12 lg:py-16 overflow-hidden bg-white">
      <section className="flex flex-col md:grid md:items-center" style={{ gridTemplateColumns: '1fr 1.5fr 1fr' }}>
        {/* LEFT VISUALS */}
        <div className="relative overflow-hidden h-[300px] sm:h-[300px] lg:h-[300px] xl:h-[350px] order-1 md:order-none flex items-center justify-center">
          <Image
        ...
        {/* RIGHT VISUALS */}
        <div className="relative overflow-hidden h-[290px] sm:h-[300px] lg:h-[300px] xl:h-[350px] order-3 md:order-none flex items-center justify-center">
          <Image
