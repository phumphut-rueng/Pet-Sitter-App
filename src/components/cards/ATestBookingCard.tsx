...
/* ---------- Config ---------- */
const STATUS_CONFIG = {
  waiting: { dot: "bg-pink", text: "text-pink", label: "Waiting for confirm", bg: "bg-gray-1" },
    ...
    >
      ...
      <div className="flex items-start gap-3 md:gap-4">
        ...
        <div className="flex-1 min-w-0">
          {/* Title + sitter */}
          <h3 className="truncate text-[18px] md:text-[24px] font-bold text-ink">{title}</h3>
          <p className="truncate text-[14px] md:text-[18px] text-ink">By {sitterName}</p>
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-0">
        ...
        <div className="flex-1 md:pr-6">
          <div className="flex flex-wrap items-center justify-between gap-y-1">
            ...
            {status === "waiting" && <ChangeButton onClick={onChange ?? (() => {})} />}
          </div>
          <p className="mt-1 text-[15px] md:text-[16px] font-medium text-ink break-words">
        ...
        <div className="flex-1 md:pr-6">
          ...
          <p className="text-[16px] font-medium text-gray-900 mt-1">{duration}</p>
        </div>
        ...
        <div className="flex-1">
          ...
          <p className="text-[16px] font-medium text-gray-900 mt-1">{pet}</p>
        </div>
      </div>
