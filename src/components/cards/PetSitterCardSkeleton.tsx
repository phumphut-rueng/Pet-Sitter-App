...
export function PetSitterCardSkeleton({ className }: { className?: string }) {
  return (
    <article
      className={cn(
        "group grid cursor-pointer grid-cols-1 lg:grid-cols-[224px_1fr] gap-4 rounded-2xl border border-border bg-white p-4 animate-pulse",
        className
      )}
    >
      {/* Mobile Layout - Cover Image */}
      <div className="block lg:hidden">
        <div className="h-48 w-full overflow-hidden rounded-xl bg-gray-200 mb-4">
